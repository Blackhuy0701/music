function check() {
    ...
    if (question1=="Biết ơn Võ Thị Sáu") {correct++;}
    if (question2=="Côn Đảo") {correct++;}
    if (question3=="1933") {correct++;}
    if (question4=="Đại tá") {correct++;}
    if (question5=="D. Hoạ sĩ") {correct++;}
    if (question6=="Hà Nội") {correct++;}
    if (question7=="2016") {correct++;}
    if (question8=="Mùa xuân chị đã dâng cả cuộc đời") {correct++;}
    if (question9=="1958") {correct++;}
