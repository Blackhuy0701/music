function check() {
    ...
    if (question1=="Ngô Quỳnh") {correct++;}
    if (question2=="Nhịp 3/4") {correct++;}
    if (question3=="Không") {correct++;}
    if (question4=="Sol Si Đô Rê Mi Fa" || question4=="Sòl Sì Đô Rê Mi Fa" || question4=="Sòl Si Đô Rê Mi Fa") {correct++;}
    if (question5=="D. Đen, trắng, trắng chấm dôi") {correct++;}
    if (question6=="Repeat sign") {correct++;}
