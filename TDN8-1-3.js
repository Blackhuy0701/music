function check() {
    ...
    if (question1=="Ba Lan" || question1=="Ba Lan.") {correct++;}
    if (question2=="Nhịp 3/4") {correct++;}
    if (question3=="Am") {correct++;}
    if (question4=="Hoàng Anh" || question4=="Hoàng Anh.") {correct++;}
    if (question5=="D. Móc đôi, móc đơn, đen, đen chấm dôi, trắng") {correct++;}
    if (question6=="Hoà thanh" || question6=="Hoà thanh.") {correct++;}
    if (question7=="B. Do, Re, Mi, Sol, La, Si, Do") {correct++;}
