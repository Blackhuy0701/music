function check() {
    ...
    if (question1=="Đức" || question1=="Đức.") {correct++;}
    if (question2=="Nhịp 2/4") {correct++;}
    if (question3=="Hô-la-hê Hô-la-hô") {correct++;}
    if (question4=="Đức" || question4=="Đức.") {correct++;}
    if (question5=="C. Móc đơn, đen, trắng") {correct++;}
    if (question6=="Xanh ta ca hát vang" || question6=="xanh ta ca hát vang.") {correct++;}
    if (question7=="Châu Âu") {correct++;}
